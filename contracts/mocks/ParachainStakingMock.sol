...
contract ParachainStakingMock is Moonbeam.ParachainStaking {
    ...
    function setRound(uint256 newRound) external {
        _round = newRound;
    }
    ...
    function executeLeaveDelegators(address delegator, uint256 delegatorDelegationCount) external {}
